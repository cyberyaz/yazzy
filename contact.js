import {
  ...
  document.addEventListener('DOMContentLoaded', function () {
    ...
    const socials = [
      ...
      { src: 'facebookLogo.png', alt: 'Facebook', url: 'https://www.facebook.com/yasmin.simons.58/', scale: 1 },
      { src: 'spotifyLogo.png', alt: 'Spotify', url: 'https://open.spotify.com/artist/7gnxVCyVrZrWA6AIQxf3Kq?si=7GZJAKluTB6sCy4mEQqqWg', scale: 1.2 },
      { src: 'linkedinLogo.png', alt: 'LinkedIn', url: 'https://www.linkedin.com/in/yazzysimons/', scale: 1 },
    ];
